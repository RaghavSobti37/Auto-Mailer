#!/usr/bin/env python3
"""
Resend the corrected havells_myousic_call_template to test database
"""
...
def send_to_test_db():
    """Resend corrected havells_myousic_call template to test database"""
    
    print("\n" + "=" * 70)
    print("RESENDING CORRECTED HAVELLS mYOUsic CALL TEMPLATE TO TEST DATABASE")
    print("=" * 70 + "\n")
    ...
    print(f"Sending corrected template with:\n  - Deadline: February 21st, 11:59 PM\n  - Delhi Audition: January 22nd\n")
